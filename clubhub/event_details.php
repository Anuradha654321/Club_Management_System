...
$stmt = $conn->prepare("SELECT u.name, u.student_id, u.branch, u.email, u.year, u.section, ep.status 
...
$stmt->bind_param("i", $event_id);
$stmt->execute();
$enrolled_students_result = $stmt->get_result();
$enrolled_students = [];
                                    ...
                                    <tbody>
                                        <?php foreach ($enrolled_students as $student): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $student['branch'] ?: 'N/A'; ?></td>
                                                <td><?php echo $student['year'] ?: 'N/A'; ?></td>
                                                <td><?php echo $student['section'] ?: 'N/A'; ?></td>
