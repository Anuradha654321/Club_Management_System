...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($rating) || $rating < 1 || $rating > 5) {
        ...
        if ($existing_rating) {
            ...
            $stmt = $conn->prepare("UPDATE club_ratings SET rating = ?, feedback = ? WHERE id = ?");
            ...
            // Insert new rating
            $stmt = $conn->prepare("INSERT INTO club_ratings (club_id, user_id, rating, feedback) VALUES (?, ?, ?, ?)");
                    ...
                    <div class="card-body">
                        ...
                        <form action="rate_club.php?id=<?php echo $club_id; ?>" method="POST" data-validate="true">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="feedback" name="feedback" class="form-control" rows="4"><?php echo $existing_rating ? $existing_rating['feedback'] : ''; ?></textarea>
                                <div class="form-text">
